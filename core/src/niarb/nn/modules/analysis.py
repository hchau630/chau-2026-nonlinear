...
__all__ = ["Eigvals", "TensorDataFrameAnalysis"]
...
class Eigvals(torch.nn.Module):
    def forward(self, matrix: torch.Tensor) -> tdfl.DataFrame:
        logger.info(f"Calculating eigenvalues of matrix with shape {matrix.shape}...")
