# Examples
To run the following examples, first ensure that you have properly installed the `niarb` package following the instructions [here](https://github.com/hchau630/niarb#usage), and then change the working directory to `niarb/examples/SSN_ring`.
