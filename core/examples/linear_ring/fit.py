...
def main():
    ...
    # `analytical` mode means rather than simulating the dynamics, we compute
    # the exact analytical solution of the linear steady state.
    ...
    losses, state_dicts = fit.run(
        data, dataset, pipeline, N=5, progress=True, ignore_errors=True, seed=0
    )
