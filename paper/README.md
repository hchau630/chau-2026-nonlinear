...
| 2D, 2E, S2C | `2d.pdf`, `2e.pdf`, `S2c.pdf` | `python plot_oldenburg_data.py oldenburg-2024-logic --2d -o figures` |
...
| S2E, S2F | `S2e.pdf`, `S2f.pdf` | `python plot_oldenburg_ensembles.py oldenburg-2024-logic -o figures` |
